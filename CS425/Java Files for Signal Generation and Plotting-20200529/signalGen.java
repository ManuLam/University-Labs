...
public class signalGen {
	...
	public static double[] MultiSine(double[] amplitudeVect, double[] fhzVect, double Fs, double tdur, double[] phaseShiftVect){
		...
		double[] partial1=new double[Len];
		double[] partial2=new double[Len];
		double[] partial3=new double[Len];
		double[] partial4=new double[Len];
		double[] partial5=new double[Len];
