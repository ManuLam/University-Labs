...
<YYINITIAL>"//"               		{yybegin(LINECOMMENT);} /*yybegin sets the current state */
<LINECOMMENT>. 						{}
<LINECOMMENT>{newline}     			{yybegin(YYINITIAL);}

<YYINITIAL>"/*"			     		{yybegin(BLOCKCOMMENT);} /*yybegin sets the current state */
<BLOCKCOMMENT>. 					{}
